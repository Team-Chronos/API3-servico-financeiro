...
public class FinanceiroQueryRepository {
    ...
    public List<ProjetoProfissionalQueryDto> listarProfissionaisDoProjeto(Integer projetoId) {
        String sql = """
                SELECT
                    p.id AS projeto_id,
                    p.nome AS nome_projeto,
    ...
    public List<ProfissionalProjetoQueryDto> listarTodosProjetosDeProfissionaisAtivos() {
        String sql = """
                SELECT
                    u.id AS usuario_id,
                    u.nome AS usuario_nome,
        ...
        return jdbcTemplate.query(sql, profissionalProjetoRowMapper);
    }
